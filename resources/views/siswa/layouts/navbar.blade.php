                    ...
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex align-items-center">
                            <div class="user-name text-end me-3 d-none d-sm-block">
                                ...
                                <p class="mb-0 text-sm text-gray-600">{{ Auth::user()->student->classRoom->name ?? 'Siswa' }}</p>
                            </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="dropdownMenuButton" style="min-width: 12rem;">
                        <li>
                            <h6 class="dropdown-header px-4 py-2">
                                Halo, <span class="fw-bold">{{ explode(' ', Auth::user()->name)[0] }}</span> 👋
                            </h6>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item px-4 py-2" href="{{ route('siswa.profile.edit') }}">
                                <i class="icon-mid bi bi-person me-2 text-muted"></i> Profil Saya
                            </a>
                        </li>
                        <li>
